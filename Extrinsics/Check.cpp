...
#define axis_x_color glColor3f(1.0f, 0.f, 0.f)
#define axis_y_color glColor3f(0.f, 1.0f, 0.f)
#define axis_z_color glColor3f(0.f, 0.f, 1.0f)
...
void DrawGrid(){
  ...
  for(int i=-rows; i<=rows; ++i){
    glVertex3d(-cols, i, 0.0f);
    glVertex3d( cols, i, 0.0f);
  }

  for(int i=-cols; i<=cols; ++i){
    glVertex3d( i,  rows, 0.0f);
    glVertex3d( i, -rows, 0.0f);
  }
