...
void test(std::vector<cv::Mat>& img) {
    ...
    GridFastDetector(img.at(0), kp1, 500);
...
// file: L_115.jpg R_115.jpg Next: L_116.jpg
// file: L_116.jpg R_116.jpg Next: L_117.jpg
// file: L_730.jpg R_730.jpg Next: L_731.jpg
// 连续出现
// file: L_842.jpg R_842.jpg Next: L_843.jpg
// file: L_862.jpg R_862.jpg Next: L_863.jpg
// file: L_863.jpg R_863.jpg Next: L_864.jpg
// file: L_864.jpg R_864.jpg Next: L_865.jpg
// file: L_865.jpg R_865.jpg Next: L_866.jpg
// file: L_866.jpg R_866.jpg Next: L_867.jpg
// file: L_867.jpg R_867.jpg Next: L_868.jpg
// file: L_868.jpg R_868.jpg Next: L_869.jpg
// file: L_869.jpg R_869.jpg Next: L_870.jpg
// file: L_870.jpg R_870.jpg Next: L_871.jpg

 
 
int main()
{
    std::string img_dir = "/home/tam/DataSet/img/";
    ...
    for(int i=0; i < fileNames.size(); )
    {
        ...
        Mat img2 = imread(img_dir + fileNames[i+2].name, 0);
        Mat img3 = imread(img_dir + fileNames[i+1].name, 0);
        std::cout << "file: " << fileNames[i].name << fileNames[i+1].name << " Next: " << fileNames[i+2].name << std::endl;
        ...
        // temp.push_back(img2);
        // temp.push_back(img3);
        temp.push_back(logTransform2(img1(img_roi)));
        temp.push_back(logTransform2(img2(img_roi)));
        temp.push_back(logTransform2(img3(img_roi)));
        // cv::Mat img_1, img_2;
        // cv::resize(img1,img_1,cv::Size(img1.cols/2,img1.rows/2));
        // cv::resize(img2,img_2,cv::Size(img2.cols/2,img2.rows/2));
        // cv::imshow("1", img_1);
        // cv::imshow("2", img_2);
        // cv::waitKey(0);
        ...
        // std::regex re("\\d+"); // 正则表达式匹配数字
        // std::smatch match;
        // if (std::regex_search(fileNames[i].name, match, re)) {
        //     std::cout << match.str() << std::endl; // 输出匹配到的数字
        //     // input = match.suffix().str(); // 从剩余字符串中继续匹配
        // }
        // std::string file_path = img_dir + fileNames[i].name;
