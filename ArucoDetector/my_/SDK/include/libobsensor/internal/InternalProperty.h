...
typedef enum {
    ...
    OB_STRUCT_LDP_MEASURE_EXTENSION_INFO =
        1055,                                  /**<
                                                  LDP测量扩展信息，供应商TOF器件输出的测量值。注意：Gemini2/Gemini2L/Gemini2VL/Gemini2XL旧版固件不支持该指令，新版本固件才支持，请注意try-catch。SDK支持指令日期：2023年10月16日。
                                                */
    ...
    OB_PROP_DEBUG_PLATFORM_INT              = 5013, /**< sdk运行平台 */
