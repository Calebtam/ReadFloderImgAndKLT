...
void mpe::draw_cube(cv::InputOutputArray image, int index,
  ...
  auto x_color = cv::Scalar(0, 0, 255);//cv::Scalar(66, 64, 203);
  auto y_color = cv::Scalar(0, 255, 0);;//cv::Scalar(102, 193, 134);
  auto z_color = cv::Scalar(255, 0, 0);;//cv::Scalar(223, 169, 46);
  int line_width = 2;
