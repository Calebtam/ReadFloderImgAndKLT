...
namespace ob_slam {
namespace nmea_msgs {
template <class ContainerAllocator> struct Gpgga_ {
  typedef Gpgga_<ContainerAllocator> Type;

  Gpgga_()
      : header(), message_id(), utc_seconds(0.0), lat(0.0), lon(0.0), lat_dir(), lon_dir(), gps_qual(0), num_sats(0), hdop(0.0), alt(0.0),
        altitude_units(), undulation(0.0), undulation_units(), diff_age(0), station_id() {}
  Gpgga_(const ContainerAllocator &_alloc)
      : header(_alloc), message_id(_alloc), utc_seconds(0.0), lat(0.0), lon(0.0), lat_dir(_alloc), lon_dir(_alloc), gps_qual(0),
        num_sats(0), hdop(0.0), alt(0.0), altitude_units(_alloc), undulation(0.0), undulation_units(_alloc), diff_age(0),
        station_id(_alloc) {
    (void)_alloc;
  }
...
template <typename ContainerAllocator> std::ostream &operator<<(std::ostream &s, const ::nmea_msgs::Gpgga_<ContainerAllocator> &v) {
...
bool operator==(const ::nmea_msgs::Gpgga_<ContainerAllocator1> &lhs, const ::nmea_msgs::Gpgga_<ContainerAllocator2> &rhs) {
  return lhs.header == rhs.header && lhs.message_id == rhs.message_id && lhs.utc_seconds == rhs.utc_seconds && lhs.lat == rhs.lat &&
         lhs.lon == rhs.lon && lhs.lat_dir == rhs.lat_dir && lhs.lon_dir == rhs.lon_dir && lhs.gps_qual == rhs.gps_qual &&
         lhs.num_sats == rhs.num_sats && lhs.hdop == rhs.hdop && lhs.alt == rhs.alt && lhs.altitude_units == rhs.altitude_units &&
         lhs.undulation == rhs.undulation && lhs.undulation_units == rhs.undulation_units && lhs.diff_age == rhs.diff_age &&
...
template <class ContainerAllocator> struct IsMessage<::nmea_msgs::Gpgga_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::nmea_msgs::Gpgga_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::Gpgga_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::Gpgga_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::Gpgga_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::Gpgga_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct MD5Sum<::nmea_msgs::Gpgga_<ContainerAllocator>> {
  static const char *value() { return "8f51cb504898f39d8ad9f698f0b6f9cd"; }
...
template <class ContainerAllocator> struct DataType<::nmea_msgs::Gpgga_<ContainerAllocator>> {
  static const char *value() { return "nmea_msgs/Gpgga"; }

  static const char *value(const ::nmea_msgs::Gpgga_<ContainerAllocator> &) { return value(); }
};

template <class ContainerAllocator> struct Definition<::nmea_msgs::Gpgga_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct Printer<::nmea_msgs::Gpgga_<ContainerAllocator>> {
