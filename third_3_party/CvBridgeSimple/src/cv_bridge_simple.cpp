/*****************************************************************************
 *  Orbbec openvins
 *  Copyright (C) 2023 by ORBBEC Technology., Inc.
 *
...
{
  sensor_msgs::ImagePtr ptr = std::make_shared<sensor_msgs::Image>();
  toImageMsg(*ptr);
  return ptr;
}
...
{
  sensor_msgs::CompressedImagePtr ptr = std::make_shared<sensor_msgs::CompressedImage>();
