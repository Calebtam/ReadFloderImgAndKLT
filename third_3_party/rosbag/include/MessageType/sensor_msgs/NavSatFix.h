...
template <class ContainerAllocator> struct NavSatFix_ {
  typedef NavSatFix_<ContainerAllocator> Type;

  NavSatFix_() : header(), status(), latitude(0.0), longitude(0.0), altitude(0.0), position_covariance(), position_covariance_type(0) {
    position_covariance.fill(0.0);
  }
  NavSatFix_(const ContainerAllocator &_alloc)
      : header(_alloc), status(_alloc), latitude(0.0), longitude(0.0), altitude(0.0), position_covariance(), position_covariance_type(0) {
    (void)_alloc;
    position_covariance.fill(0.0);
  }
...
template <typename ContainerAllocator> std::ostream &operator<<(std::ostream &s, const sensor_msgs::NavSatFix_<ContainerAllocator> &v) {
  ob_slam::message_operations::Printer<sensor_msgs::NavSatFix_<ContainerAllocator>>::stream(s, "", v);
  return s;
}
...
// 'sensor_msgs': ['/tmp/binarydeb/ros-kinetic-sensor-msgs-1.12.5/msg']}
...
// '__weakref__', '_parsed_fields', 'constants', 'fields', 'full_name', 'has_header', 'header_present', 'names', 'package', 'parsed_fields',
// 'short_name', 'text', 'types']

template <class ContainerAllocator> struct IsFixedSize<sensor_msgs::NavSatFix_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct IsFixedSize<sensor_msgs::NavSatFix_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct IsMessage<sensor_msgs::NavSatFix_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<sensor_msgs::NavSatFix_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct HasHeader<sensor_msgs::NavSatFix_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct HasHeader<sensor_msgs::NavSatFix_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct MD5Sum<sensor_msgs::NavSatFix_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct DataType<sensor_msgs::NavSatFix_<ContainerAllocator>> {
  static const char *value() { return "sensor_msgs/NavSatFix"; }

  static const char *value(const sensor_msgs::NavSatFix_<ContainerAllocator> &) { return value(); }
};

template <class ContainerAllocator> struct Definition<sensor_msgs::NavSatFix_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct Printer<sensor_msgs::NavSatFix_<ContainerAllocator>> {
