...
template <class ContainerAllocator> struct NavSatStatus_ {
...
std::ostream &operator<<(std::ostream &s, const sensor_msgs::NavSatStatus_<ContainerAllocator> &v) {
  ob_slam::message_operations::Printer<sensor_msgs::NavSatStatus_<ContainerAllocator>>::stream(s, "", v);
  return s;
}
...
template <class ContainerAllocator> struct IsFixedSize<sensor_msgs::NavSatStatus_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsFixedSize<sensor_msgs::NavSatStatus_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct IsMessage<sensor_msgs::NavSatStatus_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<sensor_msgs::NavSatStatus_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct HasHeader<sensor_msgs::NavSatStatus_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct HasHeader<sensor_msgs::NavSatStatus_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct MD5Sum<sensor_msgs::NavSatStatus_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct DataType<sensor_msgs::NavSatStatus_<ContainerAllocator>> {
  static const char *value() { return "sensor_msgs/NavSatStatus"; }

  static const char *value(const sensor_msgs::NavSatStatus_<ContainerAllocator> &) { return value(); }
};

template <class ContainerAllocator> struct Definition<sensor_msgs::NavSatStatus_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct Printer<sensor_msgs::NavSatStatus_<ContainerAllocator>> {
