...
namespace ob_slam {
namespace nmea_msgs {
template <class ContainerAllocator> struct Gpgsa_ {
  typedef Gpgsa_<ContainerAllocator> Type;

  Gpgsa_() : header(), message_id(), auto_manual_mode(), fix_mode(0), sv_ids(), pdop(0.0), hdop(0.0), vdop(0.0) {}
  Gpgsa_(const ContainerAllocator &_alloc)
      : header(_alloc), message_id(_alloc), auto_manual_mode(_alloc), fix_mode(0), sv_ids(_alloc), pdop(0.0), hdop(0.0), vdop(0.0) {
    (void)_alloc;
  }
...
template <typename ContainerAllocator> std::ostream &operator<<(std::ostream &s, const ::nmea_msgs::Gpgsa_<ContainerAllocator> &v) {
...
bool operator==(const ::nmea_msgs::Gpgsa_<ContainerAllocator1> &lhs, const ::nmea_msgs::Gpgsa_<ContainerAllocator2> &rhs) {
  return lhs.header == rhs.header && lhs.message_id == rhs.message_id && lhs.auto_manual_mode == rhs.auto_manual_mode &&
         lhs.fix_mode == rhs.fix_mode && lhs.sv_ids == rhs.sv_ids && lhs.pdop == rhs.pdop && lhs.hdop == rhs.hdop && lhs.vdop == rhs.vdop;
}
...
template <class ContainerAllocator> struct IsMessage<::nmea_msgs::Gpgsa_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::nmea_msgs::Gpgsa_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::Gpgsa_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::Gpgsa_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::Gpgsa_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::Gpgsa_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct MD5Sum<::nmea_msgs::Gpgsa_<ContainerAllocator>> {
  static const char *value() { return "94a6ef4a36d322374b16097a5d03433e"; }
...
template <class ContainerAllocator> struct DataType<::nmea_msgs::Gpgsa_<ContainerAllocator>> {
  static const char *value() { return "nmea_msgs/Gpgsa"; }

  static const char *value(const ::nmea_msgs::Gpgsa_<ContainerAllocator> &) { return value(); }
};

template <class ContainerAllocator> struct Definition<::nmea_msgs::Gpgsa_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct Printer<::nmea_msgs::Gpgsa_<ContainerAllocator>> {
