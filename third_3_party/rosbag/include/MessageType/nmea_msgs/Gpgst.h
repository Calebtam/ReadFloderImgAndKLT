...
namespace ob_slam {
namespace nmea_msgs {
template <class ContainerAllocator> struct Gpgst_ {
  typedef Gpgst_<ContainerAllocator> Type;

  Gpgst_()
      : header(), message_id(), utc_seconds(0.0), rms(0.0), semi_major_dev(0.0), semi_minor_dev(0.0), orientation(0.0), lat_dev(0.0),
        lon_dev(0.0), alt_dev(0.0) {}
  Gpgst_(const ContainerAllocator &_alloc)
      : header(_alloc), message_id(_alloc), utc_seconds(0.0), rms(0.0), semi_major_dev(0.0), semi_minor_dev(0.0), orientation(0.0),
        lat_dev(0.0), lon_dev(0.0), alt_dev(0.0) {
    (void)_alloc;
  }
...
template <typename ContainerAllocator> std::ostream &operator<<(std::ostream &s, const ::nmea_msgs::Gpgst_<ContainerAllocator> &v) {
...
bool operator==(const ::nmea_msgs::Gpgst_<ContainerAllocator1> &lhs, const ::nmea_msgs::Gpgst_<ContainerAllocator2> &rhs) {
  return lhs.header == rhs.header && lhs.message_id == rhs.message_id && lhs.utc_seconds == rhs.utc_seconds && lhs.rms == rhs.rms &&
         lhs.semi_major_dev == rhs.semi_major_dev && lhs.semi_minor_dev == rhs.semi_minor_dev && lhs.orientation == rhs.orientation &&
         lhs.lat_dev == rhs.lat_dev && lhs.lon_dev == rhs.lon_dev && lhs.alt_dev == rhs.alt_dev;
}
...
template <class ContainerAllocator> struct IsMessage<::nmea_msgs::Gpgst_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::nmea_msgs::Gpgst_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::Gpgst_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::Gpgst_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::Gpgst_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::Gpgst_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct MD5Sum<::nmea_msgs::Gpgst_<ContainerAllocator>> {
  static const char *value() { return "e4b77f6f4c211629ab0307177f71dcee"; }
...
template <class ContainerAllocator> struct DataType<::nmea_msgs::Gpgst_<ContainerAllocator>> {
  static const char *value() { return "nmea_msgs/Gpgst"; }

  static const char *value(const ::nmea_msgs::Gpgst_<ContainerAllocator> &) { return value(); }
};

template <class ContainerAllocator> struct Definition<::nmea_msgs::Gpgst_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct Printer<::nmea_msgs::Gpgst_<ContainerAllocator>> {
