...
namespace ob_slam {
namespace nmea_msgs {
template <class ContainerAllocator> struct GpgsvSatellite_ {
  typedef GpgsvSatellite_<ContainerAllocator> Type;

  GpgsvSatellite_() : prn(0), elevation(0), azimuth(0), snr(0) {}
  GpgsvSatellite_(const ContainerAllocator &_alloc) : prn(0), elevation(0), azimuth(0), snr(0) { (void)_alloc; }
...
bool operator==(const ::nmea_msgs::GpgsvSatellite_<ContainerAllocator1> &lhs,
                const ::nmea_msgs::GpgsvSatellite_<ContainerAllocator2> &rhs) {
  return lhs.prn == rhs.prn && lhs.elevation == rhs.elevation && lhs.azimuth == rhs.azimuth && lhs.snr == rhs.snr;
}
...
template <class ContainerAllocator> struct IsMessage<::nmea_msgs::GpgsvSatellite_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::nmea_msgs::GpgsvSatellite_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::GpgsvSatellite_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::GpgsvSatellite_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::GpgsvSatellite_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::GpgsvSatellite_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct MD5Sum<::nmea_msgs::GpgsvSatellite_<ContainerAllocator>> {
  static const char *value() { return "d862f2ce05a26a83264a8add99c7b668"; }
...
template <class ContainerAllocator> struct DataType<::nmea_msgs::GpgsvSatellite_<ContainerAllocator>> {
  static const char *value() { return "nmea_msgs/GpgsvSatellite"; }

  static const char *value(const ::nmea_msgs::GpgsvSatellite_<ContainerAllocator> &) { return value(); }
};

template <class ContainerAllocator> struct Definition<::nmea_msgs::GpgsvSatellite_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct Printer<::nmea_msgs::GpgsvSatellite_<ContainerAllocator>> {
  template <typename Stream>
  static void stream(Stream &s, const std::string &indent, const ::nmea_msgs::GpgsvSatellite_<ContainerAllocator> &v) {
    s << indent << "prn: ";
