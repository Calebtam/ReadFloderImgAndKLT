...
namespace ob_slam {
namespace nmea_msgs {
template <class ContainerAllocator> struct Gpgsv_ {
  typedef Gpgsv_<ContainerAllocator> Type;

  Gpgsv_() : header(), message_id(), n_msgs(0), msg_number(0), n_satellites(0), satellites() {}
  Gpgsv_(const ContainerAllocator &_alloc)
      : header(_alloc), message_id(_alloc), n_msgs(0), msg_number(0), n_satellites(0), satellites(_alloc) {
    (void)_alloc;
  }
  ...
  typedef std::vector<
      ::nmea_msgs::GpgsvSatellite_<ContainerAllocator>,
      typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<::nmea_msgs::GpgsvSatellite_<ContainerAllocator>>>
      _satellites_type;
...
template <typename ContainerAllocator> std::ostream &operator<<(std::ostream &s, const ::nmea_msgs::Gpgsv_<ContainerAllocator> &v) {
...
bool operator==(const ::nmea_msgs::Gpgsv_<ContainerAllocator1> &lhs, const ::nmea_msgs::Gpgsv_<ContainerAllocator2> &rhs) {
  return lhs.header == rhs.header && lhs.message_id == rhs.message_id && lhs.n_msgs == rhs.n_msgs && lhs.msg_number == rhs.msg_number &&
         lhs.n_satellites == rhs.n_satellites && lhs.satellites == rhs.satellites;
}
...
template <class ContainerAllocator> struct IsMessage<::nmea_msgs::Gpgsv_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct IsMessage<::nmea_msgs::Gpgsv_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::Gpgsv_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator> struct IsFixedSize<::nmea_msgs::Gpgsv_<ContainerAllocator> const> : FalseType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::Gpgsv_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator> struct HasHeader<::nmea_msgs::Gpgsv_<ContainerAllocator> const> : TrueType {};

template <class ContainerAllocator> struct MD5Sum<::nmea_msgs::Gpgsv_<ContainerAllocator>> {
  static const char *value() { return "6f34bebc32fe085313c942a96fd39c77"; }
...
template <class ContainerAllocator> struct DataType<::nmea_msgs::Gpgsv_<ContainerAllocator>> {
  static const char *value() { return "nmea_msgs/Gpgsv"; }

  static const char *value(const ::nmea_msgs::Gpgsv_<ContainerAllocator> &) { return value(); }
};

template <class ContainerAllocator> struct Definition<::nmea_msgs::Gpgsv_<ContainerAllocator>> {
...
template <class ContainerAllocator> struct Printer<::nmea_msgs::Gpgsv_<ContainerAllocator>> {
